function Get-VbrRequiredModule {
    ...
    process {
        ...
        if ($ModuleVersion -eq ".")  {
            throw "$Name $Version or higher is required to run the Veeam.Documentor. Install the Veeam Backup & Replication console that provide the required modules."
        }
        if ($ModuleVersion -lt $Version) {
            throw "$Name $Version or higher is required to run the Veeam.Documentor. Update the Veeam Backup & Replication console that provide the required modules."
        }
    }
    end {}
}